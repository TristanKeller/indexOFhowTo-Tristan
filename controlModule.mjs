    ...
    if (this.sequence1Index < sequence1.length) {
      if (sequence1[this.sequence1Index] === sequence2[this.sequence2Index]) {
       ...
       // } else {
        ...
        //}
        if (this.sequence2Index != 0) {
          // On Rembobine la séquence1Index pour permettre une correspondance partielle
          this.sequence1Index = this.sequence1Index - this.sequence2Index + 1; // On avance d'un cran à chaque fois aussi longtemps qu'il reste des caractères dans sequence1
          this.sequence2Index = 0; // On recommence la recherche dans sequence2index
        } else {
          this.sequence1Index++;
        }
      }
